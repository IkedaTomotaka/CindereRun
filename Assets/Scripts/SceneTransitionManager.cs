...
public class SceneTransitionManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            VideoPlayerController videoPlayerController = FindObjectOfType<VideoPlayerController>();
            
            if (videoPlayerController != null)
            {
                videoPlayerController.enabled = true;
            }
            
            if (Input.GetButtonDown("Cancel"))
            {
                Debug.Log("OPStatedayo");
            }
        }
